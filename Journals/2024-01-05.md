...
I started with a simple goal : SSH into four network devices directly **S1**, **R1**, **R2** and **S2** all part of my lab setup. The first round of SSH attempts failed across the board.
