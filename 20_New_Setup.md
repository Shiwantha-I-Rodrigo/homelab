...
| **Category**                         | **Topics / Tasks**                                                                                                                                                                                                  |
| ------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Static Routing Topologies**        | • Configure linear, star, and ring topologies<br>• Practice route recursion and administrative distances<br>• Test failover by shutting interfaces                                                                  |
| **Dynamic Routing — OSPF**           | • Single area vs multi-area<br>• LSA types and route filtering<br>• DR/BDR elections<br>• Stub and NSSA areas                                                                                                       |
| **Dynamic Routing — EIGRP**          | • Neighborship formation<br>• Metric tuning, variance for unequal-cost load-balancing<br>• Route summarization                                                                                                      |
| **Dynamic Routing — BGP**            | • iBGP + eBGP lab on 3 routers<br>• Route filters: prefix-lists, AS-PATH ACLs<br>• Local preference, MED, weight<br>• BGP failover and path-selection tuning<br>• Multi-homing simulation using two routers as ISPs |
| **VLANs & Inter-VLAN Routing**       | • Create 3–5 VLANs<br>• Router-on-a-stick (L2 switch)<br>• SVI routing (L3 switch)<br>• Practice trunking (802.1Q)                                                                                                  |
| **Spanning-Tree Protocol (STP)**     | • PVST+, RSTP<br>• Root bridge elections<br>• PortFast, BPDU Guard, Root Guard<br>• Create loops and observe convergence                                                                                            |
| **EtherChannel (LACP/PAgP)**         | • Build port channels<br>• Test load-balancing and failover                                                                                                                                                         |
| **Redistribution Between Protocols** | • Redistribute OSPF ⇆ EIGRP<br>• OSPF ⇆ BGP tagging to avoid loops<br>• Filtering during redistribution                                                                                                             |
| **Policy-Based Routing (PBR)**       | • Route traffic based on source subnet<br>• Failover policies                                                                                                                                                       |
| **ACLs**                             | • Standard vs extended ACLs<br>• Inbound vs outbound placement<br>• Filtering ICMP, SSH, HTTP traffic<br>• Reflexive and time-based ACLs                                                                            |
| **VPNs and Tunnels**                 | • GRE tunnel between two routers<br>• GRE over IPsec<br>• DMVPN Phase 1/2/3<br>• Site-to-site IPsec between routers                                                                                                 |
| **Device Hardening**                 | • SSH vs Telnet<br>• Secure password hashing<br>• AAA (local or RADIUS/TACACS+ with VM)                                                                                                                             |
| **Convergence Testing**              | • Shut links and observe routing changes<br>• Debug OSPF/EIGRP/BGP neighbor issues<br>• MTU mismatches, passive interfaces, wrong masks                                                                             |
| **Packet Capture**                   | • Use SPAN on the switch<br>• Capture traffic with Wireshark<br>• Analyze routing protocol packets                                                                                                                  |
| **DHCP + Relay**                     | • One router as DHCP server<br>• Forward DHCP requests using IP helper                                                                                                                                              |
| **DNS**                              | • One VM as DNS server                                                                                                                                                                                              |
| **NAT/PAT**                          | • Static vs dynamic NAT<br>• Overload for multiple subnets<br>• NAT with multiple ISPs                                                                                                                              |
